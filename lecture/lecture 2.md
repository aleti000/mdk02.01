...
### 1. Основные понятия управления дисками в Linux
...
### 3. Базовые команды `parted`

#### 3.1. Просмотр информации о дисках
...
#### 3.2. Работа с конкретным диском
...
#### 3.6. Настройка таблицы разделов
Чтобы изменить тип таблицы разделов (например, MBR → GPT):
```bash
mklabel gpt
```

#### 3.7. Выход из программы
